...
export default function PlacesFormPage(){
    ...
    // fetch can also be used to request and get data from backend api instead of axios
    ...
    async function savePlace(ev){
        ...
        if(id){ 
            ...
            await axios.put('https://backend-2eaf.onrender.com/places', {id, ...placeData});
            setRedirect(true);
        }else{
            // new place place
            await axios.post('https://backend-2eaf.onrender.com/places', placeData);
            setRedirect(true);
        }
    }
